          ...
          <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
            ...
            <div className="p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">
                5 Principles of Modern Website Design Every Business Needs
              </h3>
              <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-6">
                Discover the essential design principles that improve user experience, increase engagement, and help websites convert more visitors into customers.
              </p>
          ...
          <div className="space-y-6 md:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-4">
                    Creating User Interfaces That Feel Simple and Intuitive
                  </h3>
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    Learn practical UI/UX techniques for designing interfaces that are visually appealing, easy to navigate, and optimized for every screen size.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="p-6 md:p-10 flex flex-col justify-center">
                  <h3 className="text-lg md:text-2xl font-bold mb-3 md:mb-4">
                    How Motion and Editing Can Transform Your Brand
                  </h3>
                  <p className="text-gray-600 text-sm md:text-lg leading-relaxed">
                    Learn practical UI/UX techniques for designing interfaces that are visually appealing, easy to navigate, and optimized for every screen size.
                  </p>
